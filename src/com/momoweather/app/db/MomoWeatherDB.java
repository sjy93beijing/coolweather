...
public class MomoWeatherDB {
	 ...
	 * 将构造方法私有化
	 */
	private MomoWeatherDB(Context context) {
		MomoWeatherOpenHelper dbHelper = new MomoWeatherOpenHelper(context,
